import{a0 as e,ag as m}from"./iframe-DKYY5uNa.js";import{C as d}from"./CodeEditor-D7VTaJs8.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-lI02kiW-.js";const x={title:"Lab/CodeEditor",component:d,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
