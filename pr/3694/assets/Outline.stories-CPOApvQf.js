...
}`,...S.parameters?.docs?.source},description:{story:"Deep nesting with multiple indent levels",...S.parameters?.docs?.description}}};const Ne=["Basic","Controlled","Compact","WithDocument","ExtractFromMarkdown","ExtractFromHTML","DeepNesting"];export{I as Basic,T as Compact,E as Controlled,S as DeepNesting,H as ExtractFromHTML,O as ExtractFromMarkdown,M as WithDocument,Ne as __namedExportsOrder,qe as default};
